/*
 * This file contains everything we need to initialize GLFW and GLAD
 * It's not too much, but it's much nicer to be able to pack everything
 * into just a few small function calls
 */
